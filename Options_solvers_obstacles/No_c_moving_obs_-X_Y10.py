#In this example the obstacle is moving in the negative X direction. The obstacle is in y=10.The car avoids the collision by changing it's trajectory
...
x_obs_initial = 101  # Initial x position of the obstacle
y_obs_initial = 10   # Initial y position of the obstacle
