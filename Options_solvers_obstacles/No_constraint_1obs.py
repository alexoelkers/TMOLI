#For this solver we don't add a constraint for the obstacle, we add the obstacle directly to the cost function. IT WORKS (1 Static obstacles)
...
def main():
    ...
    for i in range(0, N):
        ...
        # Obstacle avoidance constraint (penalty)
