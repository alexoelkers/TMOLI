#In this example the obstacle is moving in the X direction. The obstacle is in y=0, so the car "overtakes"
...
obstacle_speed = 20  # Speed of the obstacle in the x-direction
